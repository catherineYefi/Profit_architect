...
function BlackBox({ nicheId, params, targetRevenue, targetMargin, targetProfit }) {
  ...
  return (
    <div style={{ marginBottom: 24 }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 148px 1fr', alignItems: 'center', gap: 0 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'stretch', padding: '0 6px', gap: 6 }}>
          ...
          <div style={{
            ...
            <div style={{ fontFamily: 'Syne', fontSize: 9, fontWeight: 700, color: '#fff', textAlign: 'center', position: 'relative', lineHeight: 1.3 }}>
              Архитектор<br/>прибыли
            </div>
            <div style={{
        ...
        {niche.nextStepStreams.map((s, i) => {
          ...
          return (
            <div key={i} style={{
              ...
              borderRadius: 8, padding: '12px 10px', position: 'relative', overflow: 'hidden',
            }}>
